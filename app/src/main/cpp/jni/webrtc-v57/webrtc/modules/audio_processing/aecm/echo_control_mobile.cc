                           ...
                           size_t nrOfSamples, int16_t msInSndCardBuf,int32_t &xdCoherence, int32_t &xeCoherence, int32_t &aecRatio)
{
    ...
    //yangrui 0814
    xdCoherence = aecm->aecmCore->hNlXdMean;
    xeCoherence = aecm->aecmCore->hNlXeMean;
    aecRatio = aecm->aecmCore->hAecRatio;

   // LOGI("%s_%d, XDCoherence : %d, aecRatio  : %d",__FILE__,__LINE__ , xdCoherence, aecRatio);
