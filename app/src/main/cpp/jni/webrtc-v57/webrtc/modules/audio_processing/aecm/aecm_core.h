...
/*
  //yangrui 0814
typedef struct CoherenceStateM {
  int16_t sde[PART_LEN][2];  // cross-psd of nearend and error
  int16_t sxd[PART_LEN][2];  // cross-psd of farend and nearend
  int16_t sxe[PART_LEN][2];  // cross-psd of farend and error
  float sx[PART_LEN], sd[PART_LEN], se[PART_LEN];  // far, near, error psd
} CoherenceStateM;
*/
typedef struct {
    int farBufWritePos;
