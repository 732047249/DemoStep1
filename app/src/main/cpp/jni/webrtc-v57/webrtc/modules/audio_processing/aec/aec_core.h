...
typedef struct CoherenceState {
  ...
  float sumSd, sumSe, sumSx, seHigh, seLow, cohedMean,singleSumSe, tempSumSe[10], doubleSumSe, scaleF;
} CoherenceState;
...
struct AecCore {
  ...
  float wfBufPre[2][kExtendedNumPartitions * PART_LEN1];  // Previous filter fft 
  ...
  short dtState, dtStatePre, dtStatePre2, suppState;
  short divergeState;
  float hNlXdAvgPre, hNlXdAvgLocalMin;
